        ...
        <div>
            ...
            <VerticalTimeline className="timeline">
                ...
                >
                    ...
                    <h4 className="timeline-subtitle">Urbana, IL</h4>
                    <em>Fall 2020</em>
                    <p>Developed a dashboard that allows the 3DP4ME nonprofit increase the design and distribution of 3D printed hearing
                ...
                >
                    ...
                    <h4 className="timeline-subtitle">Bloomington, IL</h4>
                    <em>Summer 2020</em>
                    <p>Developed a Technical Recovery Plan application that supported application backups</p>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                    className="vertical-timeline-element--work"
                    contentStyle={{ background: '#7510f7', color: '#fff' }}
                ...
                >
                    ...
                    <h4 className="timeline-subtitle">Bloomington, IL</h4>
                    <em>Summer 2019</em>
                    <p>Developed Dropoff, an application that tracks and manages form approval through company management</p>
                </VerticalTimelineElement>
